...
class VideoToCartoonApp(ctk.CTkToplevel):
    def __init__(self, parent):
        ...
        self.overrideredirect(True)  # Hide native window bar AFTER setting geometry

        self._offsetx = 0
        self._offsety = 0

        # Main container frame filling the entire window
        ...
        # Make window rounded on Windows (delayed so window is fully initialized)
        ...
        # Enable dragging window via header
        ...
        # Inner frame to center controls horizontally
        controls_inner = ctk.CTkFrame(controls, fg_color="transparent", height=40, width=500)
        ...
        self.capture_btn.pack(side="left", padx=100)
        # Start camera thread
    ...
    # --- Rounded window support (Windows only) ---
    ...
    def update_video_feed(self):
        ...
        self.after(0, self.update_frame)  # Start immediately

    def update_camera_label(self, img):
